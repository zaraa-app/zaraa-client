      ...
      <View className="flex-row items-end justify-center space-x-5">
        ...
        <View className="mb-2 items-center">
          ...
          <Image
            ...
            resizeMode="contain"
          />
          <Text className="mt-1 text-2xl font-bold text-white">{topThree[1].score}</Text>
        ...
        <View className="relative mt-6 items-center">
          <Image source={{ uri: topThree[0].image }} className="h-28 w-28 rounded-full border-2 border-white" />
          {/* 🔹 FIXED Crown Image */}
          <Image
            style={{ width: 135, height: 35 }}
            source={require("@/assets/images/crown.png")}
            className="absolute -top-10 h-12 w-12"
            resizeMode="contain"
          />
          <Image
            style={{ width: 150, height: 50 }}
            ...
            resizeMode="contain"
          />
          <Text className="mt-2 text-2xl font-bold text-white">{topThree[0].score}</Text>
        ...
        <View className="mb-2 items-center">
          ...
          <Image
            ...
            resizeMode="contain"
          />
          <Text className="mt-1 text-2xl font-bold text-white">{topThree[2].score}</Text>
