    ...
    <View className="items-center rounded-b-[56px] bg-primary-300" style={[styles.px6, styles.py4]}>
      ...
      <View className="w-full flex-row items-center justify-between" style={[styles.px2]}>
        ...
        <View className="mb-20 items-center" style={[styles.gap1]}>
          ...
          <Image source={{ uri: topThree[1].avatar.toString() }} className="h-20 w-20 rounded-full bg-white" />
        ...
        <View className="relative mt-20 items-center">
          ...
          <Image source={{ uri: topThree[0].avatar.toString() }} className="h-24 w-24 rounded-full bg-white" />
        ...
        <View className="mb-20 items-center" style={[styles.gap1]}>
          ...
          <Image source={{ uri: topThree[2].avatar.toString() }} className="h-20 w-20 rounded-full bg-white" />
