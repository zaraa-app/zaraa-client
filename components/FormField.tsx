...
interface FormFieldProps {
  ...
  textContentType?: "none" | "password" | "username" | "emailAddress" | "telephoneNumber";
}
  ...
  return (
    <View style={[styles.gap1]}>
      ...
      <View className="flex-row items-center" style={[styles.gap2]}>
        <TextInput
          className="flex-1 overflow-hidden rounded-lg border border-neutral-300 focus:border-primary-300"
